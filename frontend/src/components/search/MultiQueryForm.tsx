...
import type { ExtractorInfo, FilterCondition } from "@/types/api"
...
export function MultiQueryForm({ extractors, onSearch, loading }: Props) {
  ...
  function submit(e: React.FormEvent) {
    ...
    onSearch({ queryTexts: validQueries, extractorNames: selectedExtractors, filters: [] })
  }
